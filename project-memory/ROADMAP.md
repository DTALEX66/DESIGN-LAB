...
- 最近一次自动化验证基线：`a5570f1`（已推送，exact-SHA CI run `31830565812` 成功）新增 Open Design 文件路径 fail-closed（`is_file()`）和 visual-pack 路径 containment 回归；Canonical 16/16、Open Design 474/474、Python 180 passed、MiniGame 319 passed
