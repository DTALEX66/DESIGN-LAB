...
- 最近一次自动化验证基线：`5bb2ef4`（本地提交，待 exact-SHA CI）新增 Open Design 文件路径 fail-closed（`is_file()`）和 visual-pack 路径 containment 回归；Canonical 16/16、Open Design 474/474、Python 180 passed、MiniGame 319 passed；前一 exact-SHA CI `9189383` 已成功
