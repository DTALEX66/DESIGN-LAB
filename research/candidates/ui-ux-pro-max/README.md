...
```bash
# Generate and persist to packages/design-system/MASTER.md
...
This creates a `packages/design-system/` folder structure:
...
1. When building a specific page (e.g., "Checkout"), first check `packages/design-system/pages/checkout.md`
2. If the page file exists, its rules **override** the Master file
3. If not, use `packages/design-system/MASTER.md` exclusively
