"""
run_test_scenarios.py â€” Skill 265: game-ui-mobile-friendly-design
...
SKILLS = ROOT / "skills"
GATES = ["U1","U2","U3","U4","U5","U6"] + [g["id"] for g in [{"id": "G1", "check": "Thumb-zone placement (Fitts) applied", "fix": "Apply thumb-zone placement"}, {"id": "G2", "check": "Touch targets sized (>=44-48 px)", "fix": "Size touch targets"}, {"id": "G3", "check": "Density/contrast/readability addressed", "fix": "Address density/readability"}, {"id": "G4", "check": "One-handed/accessibility addressed", "fix": "Address accessibility"}]]
VERDICTS = ["Touch-Friendly & Usable", "Conditional (reach tweaks)", "Poor Ergonomics", "Inconclusive"]
