# PROJECT-detail.md — Skill 265: game-ui-mobile-friendly-design

## Executive Summary

`game-ui-mobile-friendly-design` is a professional-grade harness for Claude Code targeting the
**Mobile Game UI/UX & Touch Interaction Design** domain. It transforms Claude into a domain-expert that delivers
...
|------|----------------|----------------|
| Practitioner | "Analyze Mobile Game UI/UX & Touch Interaction Design case X" | Full evidenced report |
...
USER INPUT
    │
    ▼
[main.md — game-ui-mobile-friendly-design]
    │
    ...
    ├─► sub-core-analysis.md  → Design a mobile-friendly, touch-friendly game UI optimizing reach, readability, and one-handed/accessible play, grounded in HCI ergonomics.
...
- **Role:** intake specialist for a Mobile Game UI/UX & Touch Interaction Design engagement
...
- **Role:** Mobile Game UI/UX & Touch Interaction Design data librarian
...
- **Purpose:** Design a mobile-friendly, touch-friendly game UI optimizing reach, readability, and one-handed/accessible play, grounded in HCI ergonomics.
- **Role:** mobile-game UI/UX & touch-interaction designer
- **Inputs:** Device, orientation, core actions, audience, language.
- **Outputs:** Placement + touch targets + gestures + density/readability + accessibility + scenarios.
- **Tools:** - Image analysis (UI)
- Read (SECOND-KNOWLEDGE-BRAIN.md)
- WebFetch (HIG, Material, WCAG)
- **Quality Gate:** Thumb-zone placement (Fitts); touch targets sized; density/contrast/readability; one-handed/accessibility addressed.
...
- **Role:** research librarian for Mobile Game UI/UX & Touch Interaction Design
...
- **Role:** senior Mobile Game UI/UX & Touch Interaction Design advisor
...
- **Quality Gate:** Conclusion is exactly one of: Touch-Friendly & Usable / Conditional (reach tweaks) / Poor Ergonomics / Inconclusive; disclosure appears before the conclusion.
...
```
1. User invokes /game-ui-mobile-friendly-design [query]
...
> Tạo skill tự động hóa quy trình phân tích và đề xuất giải pháp thiết kế giao diện game thân thiện với người bị mù màu (Colorblind Accessibility), việc đánh giá và đưa đề xuất phải dựa trên các phương pháp đánh giá uy tín trên thế giới và đưa ra các đề xuất, giải pháp cải tiến, không ngừng đi crawl data từ các tiêu chuẩn thiết kế tiếp cận toàn cầu hoặc document uy tín liên quan để cập nhật kiến thức cho skill ngày càng tốt hơn, xu hướng hơn.
