# CLAUDE.md — Skill 265: game-ui-mobile-friendly-design

## Skill Identity
- **Skill Name:** `game-ui-mobile-friendly-design`
- **Tagline:** Mobile-Friendly Game UI Design & Touch-Friendly Interaction — Mobile Game UI/UX & Touch Interaction Design analysis & decision-support harness.
- **Current Phase:** Phase 0 — Architecture & Research
- **Folder:** `D:\972026\265-game-ui-mobile-friendly-design\`
...
**Mobile Game UI/UX & Touch Interaction Design**. It gathers authoritative real-time and reference data, applies
...
```
/game-ui-mobile-friendly-design invoked
│
...
├─ Step 3: sub-core-analysis   → Design a mobile-friendly, touch-friendly game UI optimizing reach, readability, and one-handed/accessible play, grounded in HCI ergonomics.
...
| `skills/sub-core-analysis.md` | Design a mobile-friendly, touch-friendly game UI optimizing reach, readability, and one-handed/accessible play, grounded in HCI ergonomics. |
...
- **WebFetch** — scrape Mobile Game UI/UX & Touch Interaction Design authoritative sources
...
- Semantic Scholar / Google Scholar for "Mobile Game UI/UX & Touch Interaction Design" keyword clusters
...
0 8 * * 1 python D:/972026/265-game-ui-mobile-friendly-design/tools/knowledge_updater.py >> logs/knowledge_update.log 2>&1

# Daily news update (Daily 7:00 AM)
0 7 * * * python D:/972026/265-game-ui-mobile-friendly-design/tools/knowledge_updater.py --news-only >> logs/knowledge_news.log 2>&1
```
...
- [x] Phase 6: Architecture enhancement (PRODUCTION READY v2.0.0)
- [x] Phase 7: Bulletproof production standard (PRODUCTION READY v3.0.0) 🎉
