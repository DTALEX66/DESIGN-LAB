...
- 技能：`opendesign-assistance/op-expert-suite/skills/<name>/SKILL.md`（15 个）
- 设计系统：`opendesign-assistance/design-systems/<name>/DESIGN.md`（3 个）
...
- 仓库源（唯一权威）：`opendesign-assistance/op-expert-suite/skills/<name>/SKILL.md` 与 `opendesign-assistance/design-systems/<name>/DESIGN.md`
