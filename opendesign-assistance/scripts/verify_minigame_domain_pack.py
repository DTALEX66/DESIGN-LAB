...
def main() -> int:
    ...
    while root != root.parent and not (root / "opendesign-assistance" / "domain-packs" / "minigame-design").is_dir():
        root = root.parent
    pack = root / "opendesign-assistance" / "domain-packs" / "minigame-design"
