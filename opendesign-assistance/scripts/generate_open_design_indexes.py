...
def generate_asset_counts(root: Path) -> Path:
    ...
    counts = {
        "schemaVersion": "open-design-assistance/asset-counts/v1",
        "task": "V42-0106",
        "generated_at": None,  # filled below
        "source": "generated by scripts/generate_open_design_indexes.py from directory scans and registry JSONs",
        "plugins": _dir_count(root, "plugins"),
        "bundles": _dir_count(root, "bundles"),
        "personal_skills": _dir_count(
            root, "op-expert-suite/skills", manifest_name="SKILL.md"
        ),
