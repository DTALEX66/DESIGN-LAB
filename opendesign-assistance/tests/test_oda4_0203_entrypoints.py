...
BUNDLES = REPO / "opendesign-assistance" / "bundles"
PLUGINS = REPO / "opendesign-assistance" / "plugins"
CONFIG = REPO / "opendesign-assistance" / "config" / "entrypoint-convergence.json"
