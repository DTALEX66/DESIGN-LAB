...
description: |
  电商 PDP/结算设计专家（OPEN-DESIGN-Assistance 个人专家套件）。
...
- 参考：`D:\All projects\OPEN-DESIGN-Assistance\opendesign-assistance\domain-packs\uiux-design\benchmarks\ecommerce-pdp-checkout-golden\`
