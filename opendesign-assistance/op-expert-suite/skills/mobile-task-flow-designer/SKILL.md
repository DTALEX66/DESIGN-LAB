...
description: |
  移动端任务流 UI 设计专家（OPEN-DESIGN-Assistance 个人专家套件）。
...
- 完整参考：`D:\All projects\OPEN-DESIGN-Assistance\opendesign-assistance\domain-packs\uiux-design\benchmarks\mobile-task-flow-golden\`
