...
The root repository still needs an explicit owner decision on its overall license. Plugin-level `MIT` declarations do not automatically license all historical code, MINIGAME assets, imported design-system materials or generated media.
