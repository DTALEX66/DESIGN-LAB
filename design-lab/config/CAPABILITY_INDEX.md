...
|---|---|---|---|---|---|
| `design-intelligence` | Brief, direction, design system and critique intelligence | E2 | all | DTALEX66 | `design-lab/intelligence/, packages/capabilities/atoms/brief-normalizer/, packages/capabilities/atoms/source-intake-gate/` |
...
| `visual-quality` | Visual quality, design feeling and anti-AI-slop engine | E2 | all | DTALEX66 | `packages/capabilities/quality/, packages/capabilities/bundles/visual-quality-core/, design-lab/evals/rubrics/visual-quality-core.rubric.json, design-lab/knowledge/visual-quality/, design-lab/scripts/score_visual_quality.py, design-lab/scripts/score_design_critique.py, design-lab/scripts/compare_visual_iterations.py, design-lab/scripts/verify_visual_scoring_v3.py` |
