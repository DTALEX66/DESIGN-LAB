...
design-lab/ = 面向任意设计 AGENT 平台的能力增强层：Brief/来源/权利、Scenario/Atom/Bundle、专业知识、Rubric、设计技能/设计体系/设计规范、生产预检、交付合同和证据索引
```
...
```bash
python design-lab/scripts/scaffold_open_design_plugin.py my-plugin-director
```
