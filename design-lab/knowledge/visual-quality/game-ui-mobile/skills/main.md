...
Design a mobile-friendly, touch-friendly game UI optimizing reach, readability, and one-handed/accessible play, grounded in HCI ergonomics.

**Gate:** Thumb-zone placement (Fitts); touch targets sized; density/contrast/readability; one-handed/accessibility addressed.
...
**Gate:** Conclusion is exactly one of: Touch-Friendly & Usable / Conditional (reach tweaks) / Poor Ergonomics / Inconclusive; disclosure appears before the conclusion.
...
| G1 | Thumb-zone placement (Fitts) applied | Apply thumb-zone placement |
| G2 | Touch targets sized (>=44-48 px) | Size touch targets |
| G3 | Density/contrast/readability addressed | Address density/readability |
| G4 | One-handed/accessibility addressed | Address accessibility |
...
| `sub-core-analysis` | Step 3 — Design a mobile-friendly, touch-friendly game UI optimizing reach, rea |
...
- **WebSearch** / **WebFetch** — Mobile Game UI/UX & Touch Interaction Design sources
...
**Date:** YYYY-MM-DD | **Analyst:** game-ui-mobile-friendly-design v1.0 | **Language:** Vietnamese/English | **Domain:** Mobile Game UI/UX & Touch Interaction Design
