...
任务包：DL-TP-20260906-R3；生成时观察 SHA（不是当前 HEAD）：`ed8d45ab2857b312f6056c43f7bb5e19dd9b65eb`。

唯一编辑源：`design-lab/config/task-ledger-r3.json`。生成时间 2026-09-07T19:22:46+00:00 不代表重新测试或实机验收。
