...
- Git：分支 `main`，HEAD `9e0820a54efa`，origin/main `edfa6eef29c6`，worktree dirty
- tracked 文件：3018；仓库 pack：199.75 MiB（预算 256 MiB，预警 220 MiB）

## 来源治理
- 活动登记（v3）：0；隔离登记：162（162 条遗留已隔离，DL-KNW-003）

## 能力与证据
- 能力索引：2319 项；证据卡：12（authoritative accepts=0）
- 各能力证据等级分布：E1=7；E3=1
