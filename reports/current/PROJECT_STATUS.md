...
任务包：DL-TP-20260908-R5；生成时观察 SHA（不是当前 HEAD）：`042ac635ae7a6042db366f7fb19508fc5db7bc65`。

subject_type：`WORKTREE`；worktree_clean：`False`；worktree_digest：`sha256:2b8a92c1a5552905…`；test_run_id：`testrun-20260917T142806Z-forward-repeat-08a91a030805`。

唯一编辑源：`design-lab/config/task-ledger-r3.json`。生成时间 2026-09-19T23:59:15+00:00 不代表重新测试或实机验收。
