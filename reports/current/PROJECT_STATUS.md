...
任务包：DL-TP-20260908-R5；生成时观察 SHA（不是当前 HEAD）：`a6aeccf6b532417f57dc9f1e66f58cee749f603a`。

subject_type：`WORKTREE`；worktree_clean：`False`；worktree_digest：`sha256:6185b649c0214aa6…`；test_run_id：`testrun-20260920T001141Z-forward-repeat-77de1a4fabbb`。

唯一编辑源：`design-lab/config/task-ledger-r3.json`。生成时间 2026-09-23T20:33:32+00:00 不代表重新测试或实机验收。
