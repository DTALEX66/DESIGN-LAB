...
任务包：DL-TP-20260908-R5；生成时观察 SHA（不是当前 HEAD）：`a214f49ccfd7521e7ad8ee452c7ced4b3cb70010`。

subject_type：`COMMIT`；worktree_clean：`True`；worktree_digest：`sha256:729d86b54772c407…`；test_run_id：`testrun-20260920T001141Z-forward-repeat-77de1a4fabbb`。

唯一编辑源：`design-lab/config/task-ledger-r3.json`。生成时间 2026-09-20T15:20:34+00:00 不代表重新测试或实机验收。
