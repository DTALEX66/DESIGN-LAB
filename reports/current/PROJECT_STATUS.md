...
任务包：DL-TP-20260908-R5；生成时观察 SHA（不是当前 HEAD）：`9f89452e801fe86e56d541316fcb92db927edec2`。

subject_type：`WORKTREE`；worktree_clean：`False`；worktree_digest：`sha256:192bf3fb86aa25a7…`；test_run_id：`testrun-20260920T001141Z-forward-repeat-77de1a4fabbb`。

唯一编辑源：`design-lab/config/task-ledger-r3.json`。生成时间 2026-09-20T16:47:09+00:00 不代表重新测试或实机验收。
