...
任务包：DL-TP-20260906-R3；生成时观察 SHA（不是当前 HEAD）：`5bac7f6c3ce4b4568c9b2fb2f9a03ca392445829`。

唯一编辑源：`design-lab/config/task-ledger-r3.json`。生成时间 2026-09-07T16:22:49+00:00 不代表重新测试或实机验收。
